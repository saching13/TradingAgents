...
class MessageBuffer:
    ...
    REPORT_SECTIONS = {
        ...
        "quant_report": ("quant", "Quant Forecast Analyst"),
    ...
    def _update_current_report(self):
        ...
        if latest_section and latest_content:
            ...
            section_titles = {
                ...
                "quant_report": "Quant Forecast Analysis",
...
def save_report_to_disk(final_state, ticker: str, save_path: Path):
    ...
    if final_state.get("quant_report"):
        ...
        analyst_parts.append(("Quant Forecast Analyst", final_state["quant_report"]))
    if analyst_parts:
...
def display_complete_report(final_state):
    ...
    if final_state.get("quant_report"):
        analysts.append(("Quant Forecast Analyst", final_state["quant_report"]))
    if analysts:
